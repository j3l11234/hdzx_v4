...
class ManagerAcceptOperationTest extends DbTestCase {
    ...
    public function testCheckAuth() {
        //认证异常
        $this->specify('stop on not have dept', function () {
        ...
        $this->specify('ok on have dept', function () {
            $order = Order::findOne(20);
            $user = UserService::findIdentity(1)->getUser();
            $user->removePrivilege(User::PRIV_APPROVE_MANAGER_ALL);
    ...
    public function fixtures()
    {
        return [
            ...
            'order' => [
                ...
                'dataFile' => '@tests/codeception/common/unit/fixtures/data/models/operations/order.php'
            ],
            'user' => [
