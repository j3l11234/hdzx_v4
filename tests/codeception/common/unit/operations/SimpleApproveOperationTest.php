...
use common\operations\SimpleApproveOperation;
 ...
 * OrderOperation test
 */
class SimpleApproveOperationTest extends DbTestCase {
    ...
    public function testCheckAuth() {
        ...
        $submitOp = new SimpleApproveOperation($order, $user, $roomTable);
        try {
    ...
    public function testOperation() {
        ...
        $orderOp = OrderOperation::findOne([
            'order_id' => $order->id,
            'user_id' => $user->id,
            'type' => OrderOperation::TYPE_SIMPLE_APPROVE
            ]);
